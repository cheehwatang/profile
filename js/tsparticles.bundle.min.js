  ...
  (() => {
    ...
    t.r(i),
      t.d(i, {
        ...
        Background: () => Kt,
        BackgroundMask: () => ii,
        BackgroundMaskCover: () => ti,
        Circle: () => re,
        ClickEvent: () => si,
        Collisions: () => _i,
        CollisionsAbsorb: () => gi,
        CollisionsOverlap: () => bi,
        ColorAnimation: () => fi,
        DivEvent: () => oi,
        Events: () => li,
        ExternalInteractorBase: () => xe,
        FullScreen: () => ei,
        HoverEvent: () => ai,
        HslAnimation: () => yi,
        HslColorManager: () => be,
        ...
        Parallax: () => ni,
        ParticlesBounce: () => zi,
        ParticlesBounceFactor: () => ki,
        ParticlesDensity: () => Fi,
        ParticlesInteractorBase: () => ke,
        ParticlesNumber: () => Bi,
        ParticlesOptions: () => Qi,
        Point: () => ne,
        Range: () => ae,
        ...
        areBoundsInside: () => H,
        arrayRandomIndex: () => F,
        calcExactPositionOrRandomFromSize: () => O,
        calcExactPositionOrRandomFromSizeRanged: () => C,
        ...
        drawLine: () => _t,
        drawParticle: () => St,
        drawParticlePlugin: () => It,
        drawPlugin: () => Dt,
        drawShape: () => Rt,
        drawShapeAfterEffect: () => Et,
        drawTriangle: () => Pt,
    ...
    function C(t) {
      ...
      return O({ size: t.size, position: s });
    }
    function S(t) {
    ...
    function V(t, i, e, s, o) {
      return H(W(t, null != s ? s : 0), i, e, o);
    }
    function H(t, i, e, s) {
      let o = !0;
      return (
    ...
    function Y(t, i) {
      ...
      (t.velocity.x = f.x * t.factor.x),
        ...
        (i.velocity.x = y.x * i.factor.x),
        (i.velocity.y = y.y * i.factor.y);
    }
    function J(t, i) {
    ...
    function Q(t, i, e) {
      return t instanceof Array ? B(t, i, e) : t;
    }
    function K(t, i) {
    ...
    function at(t, i, e = !0) {
      ...
      if (s.value instanceof Array) return at({ value: B(s.value, i, e) });
      for (const [, t] of et) {
    ...
    function rt(t, i, e = !0) {
      ...
      if (s.value instanceof Array) return rt({ value: B(s.value, i, e) });
      for (const [, t] of et) {
    ...
    function St(t) {
      ...
      const {
        ...
        w = Math.cos(g),
        x = {
          a: w * (null !== (i = y.a) && void 0 !== i ? i : 1),
          b: b * (null !== (e = y.b) && void 0 !== e ? e : 1),
          c: -b * (null !== (s = y.c) && void 0 !== s ? s : 1),
          d: w * (null !== (o = y.d) && void 0 !== o ? o : 1),
        };
      r.setTransform(x.a, x.b, x.c, x.d, m.x, m.y),
        r.beginPath(),
        h && (r.globalCompositeOperation = u);
      const k = l.shadowColor;
      f.enable &&
        k &&
        ((r.shadowBlur = f.blur),
        (r.shadowColor = yt(k)),
    ...
    class Xt {
      ...
      clear() {
        ...
        t.backgroundMask.enable
          ...
          ? e.color
            ? this._paintBase(yt(e.color, e.opacity))
          ...
          (a || r) &&
            this.draw((e) => {
              ...
              const d = this.container.actualOptions,
                ...
                y = {},
                m = { fill: a ? mt(a, v) : void 0 };
              (m.stroke = r ? mt(r, f) : m.fill),
                this._applyPreDrawUpdaters(e, t, s, v, m, y),
                St({
      ...
      initBackground() {
        ...
        if (e) {
          if (t.color) {
            const i = at(t.color);
            e.backgroundColor = i ? yt(i, t.opacity) : "";
      ...
      _initCover() {
        ...
        if (i) {
          ...
          this._coverColorStyle = yt(e, e.a);
        }
      }
      _initStyle() {
    ...
    class Jt {
      ...
      manageListeners(t) {
        ...
        let a = Wt;
        if ("window" === n) (s.interactivity.element = window), (a = Ut);
        ...
        const r = I("(prefers-color-scheme: dark)");
        r &&
          (void 0 !== r.addEventListener
            ? Yt(r, "change", e.themeChange, t)
        ...
        (o.interactivity.events.onHover.enable ||
          ...
          (Yt(l, Bt, e.mouseMove, t),
          Yt(l, Vt, e.touchStart, t),
          Yt(l, Ht, e.touchMove, t),
          o.interactivity.events.onClick.enable
            ? (Yt(l, Lt, e.touchEndClick, t),
              Yt(l, Ft, e.mouseUp, t),
              Yt(l, qt, e.mouseDown, t))
            : Yt(l, Lt, e.touchEnd, t),
          Yt(l, a, e.mouseLeave, t),
          Yt(l, jt, e.touchCancel, t)),
          s.canvas.element &&
          ...
          o.interactivity.events.resize &&
            ("undefined" != typeof ResizeObserver
              ...
              : Yt(window, $t, e.resize, t)),
          document && Yt(document, Nt, e.visibilityChange, t, !1);
      }
      mouseDown() {
    ...
    class ai {
      constructor() {
        (this.enable = !1), (this.mode = []), (this.parallax = new ni());
      }
      load(t) {
        t &&
          (void 0 !== t.enable && (this.enable = t.enable),
    ...
    class yi {
      constructor() {
        (this.h = new fi()), (this.s = new fi()), (this.l = new fi());
      }
      load(t) {
    ...
    class zi {
      constructor() {
        (this.horizontal = new ki()), (this.vertical = new ki());
      }
      load(t) {
        t &&
    ...
    class Ei {
      constructor() {
        (this.enable = !1), (this.length = 10), (this.fill = new Ri());
      }
      get fillColor() {
    ...
    class Bi {
      constructor() {
        (this.density = new Fi()), (this.limit = 0), (this.value = 0);
      }
      get max() {
        return this.limit;
      }
    ...
    class Gi {
      ...
      get character() {
        var t;
        return null !== (t = this.options[Hi]) && void 0 !== t
          ? t
          : this.options[Wi];
      }
      set character(t) {
        this.options[Wi] = this.options[Hi] = t;
      }
      get custom() {
        return this.options;
      }
      ...
      get image() {
        var t;
        return null !== (t = this.options[Ui]) && void 0 !== t
          ? t
          : this.options[ji];
      }
      set image(t) {
        this.options[ji] = this.options[Ui] = t;
      }
      get images() {
        return this.image;
      }
      ...
      get polygon() {
        var t;
        return null !== (t = this.options[$i]) && void 0 !== t
          ? t
          : this.options[Ni];
      }
      set polygon(t) {
        this.options[Ni] = this.options[$i] = t;
      }
      get stroke() {
        return [];
      }
      ...
      load(t) {
        ...
        this.loadShape(t.character, Hi, Wi, !0),
          this.loadShape(t.polygon, $i, Ni, !1),
          this.loadShape(
    ...
    class Ji {
      ...
      load(t) {
        t &&
          ...
          void 0 !== t.width && (this.width = m(t.width)),
    ...
    class Qi {
      ...
      load(t) {
        ...
        if (
          (this.bounce.load(t.bounce),
          this.color.load(mi.create(this.color, t.color)),
          void 0 !== t.groups)
        )
    ...
    class ie {
      constructor(t, i) {
        (this._engine = t),
          ...
          (this.duration = 0),
          (this.fpsLimit = 120),
          (this.interactivity = new di(t, i)),
          (this.manualParticles = []),
          (this.particles = te(this._engine, this._container)),
          (this.pauseOnBlur = !0),
      ...
      setTheme(t) {
        if (t) {
          ...
          const t = I("(prefers-color-scheme: dark)"),
            i = t && t.matches,
    ...
    class oe {
      ...
      init(t, i, e, s) {
        ...
        const _ = k.retina.pixelRatio,
          P = k.actualOptions,
          M = te(this._engine, k, P.particles),
          O = M.shape.type,
          { reduceDuplicates: C } = M;
        this.shape = Q(O, this.id, C);
        const S = M.shape;
        if (e && e.shape && e.shape.type) {
          const t = Q(e.shape.type, this.id, C);
          t && ((this.shape = t), S.load(e.shape));
        }
        (this.shapeData = this._loadShapeData(S, C)),
          M.load(e),
          M.load(
            null === (n = this.shapeData) || void 0 === n ? void 0 : n.particles
          ),
          (this.interactivity = new di(z, k)),
          ...
          switch (
            ...
            case "random":
              (this.size.value = p(this.size)),
                (this.size.status = d() >= 0.5 ? "increasing" : "decreasing");
              break;
            default:
        ...
        (null == B ? void 0 : B.particleInit) && B.particleInit(k, this);
      ...
      _calcPosition(t, i, e, o = 0) {
        ...
        const c = O({ size: t.canvas.size, position: i }),
      ...
      _getRollColor(t) {
        ...
        return Math.floor(
          ...
          ? this.backColor
            ? this.backColor
            : this.roll.alter
            ? Tt(t, this.roll.alter.type, this.roll.alter.value)
            : t
          : t;
      }
      _loadShapeData(t, i) {
    ...
    class le extends ae {
      ...
      intersects(t) {
        t instanceof re && t.intersects(this);
        const i = this.size.width,
          e = this.size.height,
          s = this.position,
          o = t.position,
          n = t instanceof le ? t.size : { width: 0, height: 0 },
          a = n.width,
          r = n.height;
    ...
    class ce {
      ...
      queryCircle(t, i, e) {
        return this.query(new re(t.x, t.y, i), e);
      }
      queryRectangle(t, i, e) {
        return this.query(new le(t.x, t.y, i.width, i.height), e);
      }
      subdivide() {
        const t = this.rectangle.position.x,
          ...
          o = this.capacity;
        (this._NE = new ce(new le(t, i, e / 2, s / 2), o)),
          (this._NW = new ce(new le(t + e / 2, i, e / 2, s / 2), o)),
          (this._SE = new ce(new le(t, i + s / 2, e / 2, s / 2), o)),
          (this._SW = new ce(new le(t + e / 2, i + s / 2, e / 2, s / 2), o)),
          (this._divided = !0);
      }
    }
    class de {
      constructor(t, i) {
        (this.container = i),
          ...
          (this.needsSort = !1),
          (this.lastZIndex = 0),
          (this.interactionManager = new ee(this._engine, i));
        const e = this.container.canvas.size;
        (this.quadTree = new ce(
          new le(
            -e.width / 4,
            -e.height / 4,
            (3 * e.width) / 2,
      ...
      async update(t) {
        ...
        for (const i of this.array) {
          ...
          i.destroyed
            ? o.push(i)
            : this.quadTree.insert(new ne(i.getPosition(), i));
        }
      ...
      _pushParticle(t, i, e, s) {
        try {
          ...
          o
            ...
            : (o = new oe(this._engine, this.nextId, this.container, t, i, e));
          let n = !0;
          if ((s && (n = s(o)), !n)) return;
          return (
            this.array.push(o),
    ...
    class fe {
      constructor(t, i, e) {
        (this.id = i),
          ...
          (this.particles = new de(this._engine, this)),
          (this.frameManager = new Zt(this)),
          (this.pathGenerators = new Map()),
          (this.interactivity = { mouse: { clicking: !1, inside: !1 } }),
          (this.plugins = new Map()),
          (this.drawers = new Map()),
          (this._options = pe(this._engine, this)),
          (this.actualOptions = pe(this._engine, this)),
      ...
      addPath(t, i, e = !1) {
        return (
          !(!ue(this) || (!e && this.pathGenerators.has(t))) &&
          (this.pathGenerators.set(t, null != i ? i : ve), !0)
        );
      }
      destroy() {
        if (!ue(this)) return;
      ...
      draw(t) {
        if (!ue(this)) return;
        let i = t;
        this._drawAnimationFrame = T()(async (t) => {
      ...
      getAnimationStatus() {
        return !this._paused && !this.pageHidden && ue(this);
      }
      handleClickMode(t) {
        if (ue(this)) {
      ...
      async init() {
        ...
        (this._options = pe(
          ...
          (this.actualOptions = pe(this._engine, this, this._options));
      ...
      async loadTheme(t) {
        ue(this) && ((this._currentTheme = t), await this.refresh());
      }
      pause() {
        if (
          ue(this) &&
      ...
      async refresh() {
        if (ue(this)) return this.stop(), this.start();
      }
      async reset() {
        if (ue(this))
          return (this._options = pe(this._engine, this)), this.refresh();
      }
      setNoise(t, i, e) {
        ue(this) && this.setPath(t, i, e);
      }
      setPath(t, i, e) {
        if (!t || !ue(this)) return;
        const s = Object.assign({}, ve);
      ...
      _intersectionManager(t) {
        if (ue(this) && this.actualOptions.pauseOnOutsideViewport)
          for (const i of t)
    ...
    class ye {
      ...
      async loadOptions(t) {
        ...
        const f = new fe(this._engine, o, h);
        return (
    ...
    class ge {
      ...
      getInteractors(t, i = !1) {
        return me(t, this.interactors, this._initializers.interactors, i);
      }
      getMovers(t, i = !1) {
        return me(t, this.movers, this._initializers.movers, i);
      }
      getPathGenerator(t) {
      ...
      getUpdaters(t, i = !1) {
        return me(t, this.updaters, this._initializers.updaters, i);
      }
      loadOptions(t, i) {
    ...
    class be {
      ...
      handleColor(t) {
        ...
        if (void 0 !== e.h && void 0 !== e.s && void 0 !== e.l) return pt(e);
      }
      handleRangeColor(t) {
        var i;
        const e = null !== (i = t.value.hsl) && void 0 !== i ? i : t.value;
    ...
    const Pe = new (class {
      constructor() {
        (this._domArray = []),
          ...
          (this._initialized = !1),
          (this._loader = new ye(this)),
          (this.plugins = new ge(this));
      }
      get version() {
        return "2.9.3";
      }
    ...
    class Oe extends xi {
      constructor() {
        super(), (this.density = 5), (this.value = 50), (this.limit = new Me());
      }
      load(t) {
        t &&
          (super.load(t),
    ...
    class Se {
      constructor(t, i, e, s) {
        ...
        (this.absorbers = t),
          ...
          e instanceof Ce
            ? (this.options = e)
            : ((this.options = new Ce()), this.options.load(e)),
          (this.dragging = !1),
      ...
      draw(t) {
        t.translate(this.position.x, this.position.y),
          ...
          t.closePath(),
          (t.fillStyle = yt(this.color, this.opacity)),
          t.fill();
      }
      resize() {
        const t = this.initialPosition;
        this.position =
          t && V(t, this.container.canvas.size, o.origin)
            ? t
            : this.calcPosition();
      }
      calcPosition() {
    ...
    class Re {
      ...
      addAbsorber(t, i) {
        const e = new Se(this, this.container, t, i);
    ...
    class Ae {
      ...
      load(t) {
        ...
        t &&
          ...
          t.colorOffset &&
            ((this.colorOffset =
              null !== (i = this.colorOffset) && void 0 !== i ? i : {}),
    ...
    class Le {
      constructor() {
        (this.bounds = new De()), (this.mode = "none"), (this.split = new Ae());
      }
      load(t) {
        t &&
    ...
    class qe {
      ...
      addSplitParticle(t, i) {
        ...
        if (!n) return;
        const a = n.split,
          r = te(this.engine, this.container, t.options),
          l = g(a.factor),
          c = t.getFillColor();
        a.color
          ? r.color.load(a.color)
          : a.colorOffset && c
          ? r.color.load({
              value: {
                hsl: {
                  h:
                    c.h +
                    v(null !== (e = a.colorOffset.h) && void 0 !== e ? e : 0),
                  s:
                    c.s +
                    v(null !== (s = a.colorOffset.s) && void 0 !== s ? s : 0),
                  l:
                    c.l +
                    v(null !== (o = a.colorOffset.l) && void 0 !== o ? o : 0),
                },
              },
            })
          ...
          r.load(i);
        const d = a.sizeOffset ? m(-t.size.value, t.size.value) : 0,
          h = { x: t.position.x + p(d), y: t.position.y + p(d) };
        return this.container.particles.addParticle(h, r, t.group, (i) => {
          var e;
          return (
            !(i.size.value < 0.5) &&
    ...
    class We {
      ...
      load(t) {
        t &&
          (void 0 !== t.autoPlay && (this.autoPlay = t.autoPlay),
          void 0 !== t.size &&
            (this.size || (this.size = new He()), this.size.load(t.size)),
          void 0 !== t.direction && (this.direction = t.direction),
          (this.domId = t.domId),
          ...
          void 0 !== t.position &&
            ...
            void 0 !== t.position.y && (this.position.y = m(t.position.y))),
          void 0 !== t.spawnColor &&
            (void 0 === this.spawnColor && (this.spawnColor = new mi()),
    ...
    class Ue {
      constructor(t, i, e, s, o) {
        ...
        (this.emitters = i),
          ...
          s instanceof We
            ? (this.options = s)
            : ((this.options = new We()), this.options.load(s)),
          (this._spawnDelay =
            (1e3 *
    ...
    class je {
      ...
      addEmitter(t, i) {
        const e = new We();
        e.load(t);
        const s = new Ue(this._engine, this, this.container, e, i);
    ...
    class Xe {
      randomPosition(t, i, e) {
        if (e) return { x: Ge(t.x, i.width), y: Ge(t.y, i.height) };
        {
          const e = i.width / 2,
            s = i.height / 2,
            o = Math.floor(4 * d()),
    ...
    class Ke {
      ...
      load(t) {
        t &&
          (void 0 !== t.backColor &&
            (this.backColor = Qt.create(this.backColor, t.backColor)),
    ...
    class os {
      ...
      move(t, i) {
        ...
        const c = t.container,
          ...
          m = y(r.size.value) * c.retina.pixelRatio,
          g =
        ...
        if (l.spin.enable)
          ...
          (null == e ? void 0 : e.enable) &&
            ...
            f && g && (t.velocity.x += (f * i.factor) / (60 * g));
          const n = t.moveDecay;
    ...
    class cs extends xe {
      ...
      clickAttract() {
        ...
        if (
          ...
          if (!e || e < 0 || !i) return;
          this.processAttract(i, e, new re(i.x, i.y, e));
      ...
      hoverAttract() {
        const t = this.container,
          ...
          e = t.retina.attractModeDistance;
        !e || e < 0 || !i || this.processAttract(i, e, new re(i.x, i.y, e));
      }
    ...
    class hs extends xe {
      ...
      processMouseBounce() {
        ...
        !s || s < 0 || !e || this.processBounce(e, s, new re(e.x, e.y, s + i));
      }
      ...
      load(t) {
        if (t) {
          if (
            ...
            this.color = Z(t.color, (t) => Qt.create(i, t));
          }
          void 0 !== t.size && (this.size = t.size);
        }
      }
    ...
    class ys extends xe {
      ...
      clickBubble(t) {
        ...
        for (const t of l) {
          ...
          const c = {
            ...
            particlesObj: {
              optValue: y(t.options.size.value) * s.retina.pixelRatio,
              value: t.size.value,
            },
            type: "size",
          };
          ...
          const d = {
            ...
            particlesObj: {
              optValue: y(t.options.opacity.value),
              value:
                null !==
                  (e =
      ...
      hoverBubbleSize(t, i, e) {
        ...
        if (void 0 === o) return;
        const n = y(t.options.size.value) * s.retina.pixelRatio,
          a = fs(t.size.value, o, n, i);
    ...
    class gs {
      constructor() {
        (this.distance = 80), (this.links = new ms()), (this.radius = 60);
      }
      get lineLinked() {
        return this.links;
      }
    ...
    class zs {
      constructor() {
        (this.distance = 100), (this.links = new ks());
      }
      get lineLinked() {
        return this.links;
      }
    ...
    function _s(t, i, e, s, o) {
      t.canvas.draw((t) => {
        var n;
        const a = i.getPosition();
        !(function (t, i, e, s, o, n) {
          _t(t, e, s),
            (t.strokeStyle = yt(o, n)),
            (t.lineWidth = i),
            t.stroke();
        })(
          t,
    ...
    class Ts extends xe {
      ...
      hoverRepulse() {
        ...
        !e || e < 0 || !i || this.processRepulse(i, e, new re(i.x, i.y, e));
      }
    ...
    async function Bs(t) {
      if ("svg" !== t.type) return void (await Fs(t));
      t.loading = !0;
    ...
    function Vs(t, i, e, s) {
      ...
      const r = (function (t, i, e) {
          ...
          if (!s) return "";
          const o = mt(i, e);
          if (s.includes("fill")) return s.replace(qs, () => o);
          const n = s.indexOf(">");
      ...
      return new Promise((i) => {
        ...
        n.addEventListener("load", () => {
          ...
          n.addEventListener("error", async () => {
            ...
            await Fs(e), (l.loaded = !0), (l.element = e.element), i(l);
          }),
          (n.src = o);
      });
    }
    ...
    class js {
      constructor() {
        (this.count = 0), (this.delay = new Ws()), (this.duration = new Us());
      }
      load(t) {
        t &&
          (void 0 !== t.count && (this.count = t.count),
    ...
    class Gs {
      ...
      init(t) {
        ...
        const e = i.animation;
        if (e.enable) {
          (t.opacity.decay = 1 - v(e.decay)), (t.opacity.status = "increasing");
          const s = i.value;
          switch (
            ((t.opacity.min = f(s)), (t.opacity.max = y(s)), e.startValue)
          ) {
            case "min":
            ...
            case "random":
              (t.opacity.value = p(t.opacity)),
                (t.opacity.status = d() >= 0.5 ? "increasing" : "decreasing");
              break;
            default:
    ...
    class Ys {
      ...
      update(t, i, e, s) {
        ...
        switch (t.outType) {
          case "normal":
          case "outside":
            if (V(t.position, n.canvas.size, o.origin, t.getRadius(), i))
              return;
            break;
          case "inside": {
      ...
      update(t, i, e, s) {
        ...
        if (n.enable) {
          ...
          if (
            ...
            return;
          V(t.position, a.canvas.size, o.origin, l, i) || a.particles.remove(t);
        }
      }
    }
    class Zs {
    ...
    class Qs {
      constructor(t) {
        (this.container = t),
          (this.updaters = [new Xs(t), new Ys(t), new Zs(t), new Js(t)]);
      }
      init() {}
      isEnabled(t) {
    ...
    function so(t, i, e, s) {
      switch (t.options.collisions.mode) {
        case "absorb":
          !(function (t, i, e, s) {
            ...
            void 0 === o && void 0 !== n
              ...
              : void 0 !== o &&
                void 0 !== n &&
                (o >= n ? io(t, 0, i, n, e, s) : io(i, 0, t, o, e, s));
          })(t, i, e, s);
          break;
        case "bounce":
          eo(t, i);
        ...
        case "destroy":
          !(function (t, i) {
            t.unbreakable || i.unbreakable || eo(t, i),
    ...
    class oo extends ke {
      ...
      async interact(t, i) {
        ...
        for (const a of n) {
          ...
          w(s, n) > o + r || so(t, a, i, e.retina.pixelRatio);
        }
      }
      isEnabled(t) {
    ...
    class no extends re {
      ...
      intersects(t) {
        ...
        if (void 0 !== e.radius) {
          const t = new re(s.x, s.y, 2 * e.radius);
          return super.intersects(t);
        }
        if (void 0 !== i.size) {
          const t = new le(s.x, s.y, 2 * i.size.width, 2 * i.size.height);
          return super.intersects(t);
        }
        return !1;
      }
    ...
    class ho extends ke {
      ...
      async interact(t) {
        ...
        const n = t.options.links,
          ...
          l = n.warp,
          c = l ? new no(e.x, e.y, r, o) : new re(e.x, e.y, r),
    ...
    class po {
      ...
      drawParticle(t, i) {
        ...
        const o = i.links.filter(
          (t) =>
            s.links &&
            this.getLinkFrequency(i, t.destination) <= s.links.frequency
        );
        for (const t of o)
          this.drawTriangles(s, i, t, o),
            t.opacity > 0 &&
      ...
      drawLinkLine(t, i) {
        ...
        e.canvas.draw((i) => {
          ...
          if (!u) return;
          const f = null !== (c = t.retina.linksWidth) && void 0 !== c ? c : 0,
            y = null !== (h = t.retina.linksDistance) && void 0 !== h ? h : 0;
          !(function (t, i, e, s, o, n, a, r, l, c, d, h) {
            ...
            if (u) {
              if (
                ...
                (t.strokeStyle = yt(c, d)),
                h.enable)
              ) {
                const i = at(h.color);
                i && ((t.shadowBlur = h.blur), (t.shadowColor = yt(i)));
              }
              t.stroke();
            }
          })(
      ...
      drawTriangles(t, i, e, s) {
        var o, n, a;
        const r = e.destination;
        if (
          !(null === (o = t.links) || void 0 === o
            ? void 0
            : o.triangles.enable) ||
          !(null === (n = r.options.links) || void 0 === n
            ? void 0
            : n.triangles.enable)
        )
          return;
        const l =
          null === (a = r.links) || void 0 === a
            ? void 0
            : a.filter((t) => {
                const i = this.getLinkFrequency(r, t.destination);
                return (
                  r.options.links &&
                  i <= r.options.links.frequency &&
                  s.findIndex((i) => i.destination === t.destination) >= 0
                );
              });
        if (null == l ? void 0 : l.length)
          for (const s of l) {
            const o = s.destination;
            this.getTriangleFrequency(i, r, o) > t.links.triangles.frequency ||
              this.drawLinkTriangle(i, e, s);
          }
      }
      getLinkFrequency(t, i) {
        return uo([t, i], this._freqs.links);
      }
      getTriangleFrequency(t, i, e) {
        return uo([t, i, e], this._freqs.triangles);
      }
    }
    class vo {
      constructor() {
    ...
    async function fo(t) {
      await (async function (t) {
        await t.addInteractor("particlesLinks", (t) => new ho(t));
      })(t),
        await (async function (t) {
          const i = new vo();
          await t.addPlugin(i);
    ...
    class mo extends yo {
      getCenter(t, i) {
        return { x: -i / (t.sides / 3.5), y: -i / 0.76 };
      }
      getSidesData(t, i) {
        const e = t.sides;
        return {
          count: { denominator: 1, numerator: e },
          length: (2.66 * i) / (e / 3),
        };
      }
    }
    ...
    async function bo(t) {
      await (async function (t) {
        await t.addShape("polygon", new mo());
      })(t),
        await (async function (t) {
          await t.addShape("triangle", new go());
        })(t);
    }
    class wo {
      init(t) {
    ...
    class ko {
      draw(t, i, e) {
        t.rect(-e / xo, -e / xo, (2 * e) / xo, (2 * e) / xo);
      }
      getSidesCount() {
        return 4;
      }
    ...
    class zo {
      draw(t, i, e) {
        var s;
        const o = i.sides,
          n = null !== (s = i.starInset) && void 0 !== s ? s : 2;
        t.moveTo(0, 0 - e);
        for (let i = 0; i < o; i++)
          t.rotate(Math.PI / o),
            t.lineTo(0, 0 - e * n),
      ...
      particleInit(t, i) {
        ...
        const s = i.shapeData,
          o = v(
            null !== (e = null == s ? void 0 : s.inset) && void 0 !== e ? e : 2
          );
        i.starInset = o;
      }
    }
    function _o(t, i, e, s, o) {
      var n, a;
      const r = i;
      if (
        !r ||
    ...
    class Po {
      ...
      init(t) {
        var i, e, s;
        const o = this.container,
          n = Q(t.options.stroke, t.id, t.options.reduceDuplicates);
        (t.strokeWidth = v(n.width) * o.retina.pixelRatio),
          (t.strokeOpacity = v(
            null !== (i = n.opacity) && void 0 !== i ? i : 1
          )),
          (t.strokeAnimation =
            null === (e = n.color) || void 0 === e ? void 0 : e.animation);
        const a =
          null !== (s = ct(n.color)) && void 0 !== s ? s : t.getFillColor();
        a && (t.strokeColor = kt(a, t.strokeAnimation, o.retina.reduceFactor));
      }
      isEnabled(t) {
        var i, e, s;
        const o = t.strokeAnimation;
        return (
          !t.destroyed &&
          !t.spawning &&
          !!o &&
          ((void 0 !==
            (null === (i = t.strokeColor) || void 0 === i
              ? void 0
              : i.h.value) &&
            t.strokeColor.h.enable) ||
            (void 0 !==
              (null === (e = t.strokeColor) || void 0 === e
                ? void 0
                : e.s.value) &&
              t.strokeColor.s.enable) ||
            (void 0 !==
              (null === (s = t.strokeColor) || void 0 === s
                ? void 0
                : s.l.value) &&
              t.strokeColor.l.enable))
        );
      }
      update(t, i) {
        this.isEnabled(t) &&
          (function (t, i) {
            ...
            const e = t.strokeColor.h;
            e && _o(i, e, t.strokeAnimation.h, 360, !1);
            const s = t.strokeColor.s;
            s && _o(i, s, t.strokeAnimation.s, 100, !0);
            const o = t.strokeColor.l;
            o && _o(i, o, t.strokeAnimation.l, 100, !0);
          })(t, i);
      }
    }
    const Mo = ["text", "character", "char"];
    class Oo {
      draw(t, i, e, s) {
        var o, n, a;
        const r = i.shapeData;
      ...
      async init(t) {
        ...
        if (Mo.find((t) => L(t, i.particles.shape.type))) {
          const t = Mo.map((t) => i.particles.shape.options[t]).find(
              (t) => !!t
            ),
            e = [];
          Z(t, (t) => {
    ...
    async function Co(t) {
      await (async function (t) {
        t.addMover("base", () => new os());
      })(t),
        await (async function (t) {
          t.addMover("parallax", () => new Ks());
        })(t),
        await (async function (t) {
          await t.addInteractor("externalAttract", (i) => new cs(t, i));
        })(t),
        await (async function (t) {
          await t.addInteractor("externalBounce", (t) => new hs(t));
        })(t),
        await (async function (t) {
          await t.addInteractor("externalBubble", (t) => new ys(t));
        })(t),
        await (async function (t) {
          await t.addInteractor("externalConnect", (t) => new xs(t));
        })(t),
        await (async function (t) {
          await t.addInteractor("externalGrab", (t) => new Ps(t));
        })(t),
        await (function (t) {
          t.addInteractor("externalPause", (t) => new Ms(t));
        })(t),
        await (async function (t) {
          await t.addInteractor("externalPush", (t) => new Cs(t));
        })(t),
        await (function (t) {
          t.addInteractor("externalRemove", (t) => new Rs(t));
        })(t),
        await (async function (t) {
          await t.addInteractor("externalRepulse", (i) => new Ts(t, i));
        })(t),
        await (async function (t) {
          await t.addInteractor("externalSlow", (t) => new Ls(t));
        })(t),
        await (async function (t) {
          await t.addInteractor("particlesAttract", (t) => new to(t));
        })(t),
        await (async function (t) {
          await t.addInteractor("particlesCollisions", (t) => new oo(t));
        })(t),
        await fo(t),
        await (async function (t) {
          await t.addShape("circle", new ns());
        })(t),
        await (async function (t) {
          await t.addShape(["image", "images"], new Hs());
        })(t),
        await (async function (t) {
          await t.addShape("line", new Ns());
        })(t),
        await bo(t),
        await (async function (t) {
          const i = new ko();
        ...
        await (async function (t) {
          await t.addShape("star", new zo());
        })(t),
        await (async function (t) {
          await t.addShape(Mo, new Oo());
        })(t),
        await (async function (t) {
          await t.addParticleUpdater("life", (t) => new $s(t));
        })(t),
        await (async function (t) {
          await t.addParticleUpdater("opacity", (t) => new Gs(t));
        })(t),
        await (async function (t) {
          await t.addParticleUpdater("size", () => new wo());
        })(t),
        await (async function (t) {
          await t.addParticleUpdater("rotate", (t) => new ss(t));
        })(t),
        await (async function (t) {
          await t.addParticleUpdater("color", (t) => new rs(t));
        })(t),
        await (async function (t) {
          await t.addParticleUpdater("strokeColor", (t) => new Po(t));
        })(t),
        await (async function (t) {
          await t.addParticleUpdater("outModes", (t) => new Qs(t));
        })(t),
        await ((t) => {
    ...
    class Io {
      constructor() {
        (this.lines = new Do()), (this.particles = new Do());
      }
      load(t) {
    ...
    class To {
      getColorStyles(t, i, e, s) {
        ...
        const n = o.particles,
          ...
          p = {},
          f = a && u;
        return (p.fill = f ? u : void 0), (p.stroke = f ? u : void 0), p;
      }
      init() {}
      isEnabled(t) {
    ...
    async function Fo(t) {
      await Co(t),
        await (async function (t) {
          await t.addParticleUpdater("destroy", (i) => new qe(t, i));
        })(t),
        await (async function (t) {
          await t.addParticleUpdater("roll", () => new ts());
        })(t),
        await (async function (t) {
          await t.addParticleUpdater("tilt", (t) => new Eo(t));
        })(t),
        await (async function (t) {
          await t.addParticleUpdater("twinkle", () => new To());
        })(t),
        await (async function (t) {
          await t.addParticleUpdater("wobble", (t) => new qo(t));
        })(t),
        await (async function (t) {
          await t.addInteractor("externalTrail", (t) => new Ze(t));
        })(t),
        await (async function (t) {
          const i = new Ee();
          await t.addPlugin(i);
        ...
        await (async function (t) {
          t.emitterShapeManager || (t.emitterShapeManager = new Ne(t)),
            t.addEmitterShape ||
          ...
          const i = new Ye(t);
          await t.addPlugin(i),
            t.addEmitterShape("circle", new Fe()),
            t.addEmitterShape("square", new Xe());
        })(t);
    }
    return Fo(Pe), i;
  })()
